...
Car(1).State=[75       -1.5   0    20     0];     % x y phi v WheelAng（前轮偏角）
Car(2).State=[45       -1.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(3).State=[0         1.5   0    28     0];     % x y phi v WheelAng（前轮偏角）
Car(4).State=[90       -1.5   0    20     0];     % x y phi v WheelAng（前轮偏角）
