...
Car(1).State=[90       4.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(2).State=[90       1.5   0    20     0];     % x y phi v WheelAng（前轮偏角）
Car(3).State=[90      -1.5   0    20     0];     % x y phi v WheelAng（前轮偏角）
Car(4).State=[60       1.5   0    24     0];     % x y phi v WheelAng（前轮偏角）
 ...
 tic   
    ...
    for i_Control=1:Num_Car
        if Car(i_Control).HostFlag==1
            ...
            fprintf('Update Process, HostCar_platoon=%4.2f\n',Car(i_Control).platoon)
