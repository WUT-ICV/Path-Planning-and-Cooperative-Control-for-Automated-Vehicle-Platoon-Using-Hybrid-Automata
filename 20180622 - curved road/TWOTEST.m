...
Car(1).State=[70     -2   0    20     0];     % x y phi v WheelAng（前轮偏角）
Car(2).State=[0       2   0    25     0];     % x y phi v WheelAng（前轮偏角）
Car(3).State=[0      -2   0    28     0];     % x y phi v WheelAng（前轮偏角）
% Car(4).State=[48      -1.5   0    23     0];     % x y phi v WheelAng（前轮偏角）
