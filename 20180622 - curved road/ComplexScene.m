...
Car(1).State=[0        1.5   0    29     0];     % x y phi v WheelAng（前轮偏角）
Car(2).State=[30       1.5   0    28     0];     % x y phi v WheelAng（前轮偏角）
Car(3).State=[50       4.5   0    28     0];     % x y phi v WheelAng（前轮偏角）
Car(4).State=[70      -1.5   0    28     0];     % x y phi v WheelAng（前轮偏角）
Car(5).State=[80       4.5   0    28     0];     % x y phi v WheelAng（前轮偏角）
Car(6).State=[100      1.5   0    28     0];     % x y phi v WheelAng（前轮偏角）
Car(7).State=[110     -1.5   0    28     0];     % x y phi v WheelAng（前轮偏角）
Car(8).State=[120      4.5   0    28     0];     % x y phi v WheelAng（前轮偏角）
Car(9).State=[150      1.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(10).State=[190    -1.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(11).State=[200     4.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(12).State=[250     1.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(13).State=[300    -1.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(14).State=[320     4.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(15).State=[350     1.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
