...
%车辆状态设置
% Car(1).State=[80       4.5   0    21     0];     % x y phi v WheelAng（前轮偏角）
% Car(2).State=[80       1.5   0    20     0];     % x y phi v WheelAng（前轮偏角）
% Car(3).State=[80      -1.5   0    20     0];     % x y phi v WheelAng（前轮偏角）
% Car(4).State=[48       4.5   0    23     0];     % x y phi v WheelAng（前轮偏角）
% Car(5).State=[36       4.5   0    23     0];     % x y phi v WheelAng（前轮偏角）
% Car(6).State=[24       4.5   0    23     0];     % x y phi v WheelAng（前轮偏角）
% Car(7).State=[12       4.5   0    23     0];     % x y phi v WheelAng（前轮偏角）
% Car(8).State=[0        4.5   0    23     0];     % x y phi v WheelAng（前轮偏角）

Car(1).State=[80       4.5   0    22     0];     % x y phi v WheelAng（前轮偏角）
Car(2).State=[80       1.5   0    20     0];     % x y phi v WheelAng（前轮偏角）
Car(3).State=[120      -1.5   0    20     0];     % x y phi v WheelAng（前轮偏角）
Car(4).State=[48       4.5   0    25     0];     % x y phi v WheelAng（前轮偏角）
Car(5).State=[36      -1.5   0    25     0];     % x y phi v WheelAng（前轮偏角）
Car(6).State=[24       1.5   0    25     0];     % x y phi v WheelAng（前轮偏角）
Car(7).State=[12       4.5   0    25     0];     % x y phi v WheelAng（前轮偏角）
Car(8).State=[0        -1.5   0    25     0];     % x y phi v WheelAng（前轮偏角）
